...
- Name: map-data-service.spec.ts >> Map Data Service - E2E Tests >> Bounds Query (경계 내 리드 조회) >> should display leads within visible map bounds
- Location: tests/e2e/map-data-service.spec.ts:57:9
